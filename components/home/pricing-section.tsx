...
const plans = [
  ...
  },
  {
    ...
    items: [
      "Unlimited PDFs Summaries per month",
...
const PricingCard = ({
  ...
  return (
    <div className="relative w-full max-w-lg hover:scale-105 trasnition-all duration-300">
      <div
        className={cn(
          "fex flex-col h-full gap-4 lg:gap-8 z-10 p-8 border-[1px] border-gray-500/20 rounded-2xl",
      ...
      >
        ...
        <div className="flex gap-2">
          <p className="text-5xl tracking-tight font-semibold">{price}</p>
        </div>
