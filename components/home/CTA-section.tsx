        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center items-center">
            <div className="">
              ...
              size={"lg"}
                variant={"link"}
                className="w-full min-[400px]:w-auto bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 hover:text-white hover:no-underline transition-all duration-300 flex items-center justify-center text-white"
              >
