    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6 ">
        <div className="flex flex-wrap items-center gap-4 ">
          <Badge
            variant="secondary"
            className="relative px-4 py-1.5 text-sm font-mdeium bg-white/80 backdrop-blur-xs rounded-full hover:bg-white/90 trasnition-all duration-200 shadow-xs hover:shadow-md"
          >
      ...
      <div className="self-start">
        <Link href="/dashboard">
          <Button
            variant={"link"}
            size="sm"
            className="group flex item-center gap-1 sm:gap-2 hover:bg-white/80 backdrop-blur-xs rounded-full transition-all duration-200 shadow-xs hover:shadow-md border-rose-100/30 bg-rose-100 px-2 sm:px-3 hover:no-underline"
          >
